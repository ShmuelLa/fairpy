...
class ParetoImprovement(FractionalAllocation):
    """
    ...
    def __init__(self):
        """
        These are the main loops linear programming values that are stored for later testing.
        """
    ...
    def __is_acyclic(Gx: bipartite) -> bool:
        """
        A help function which checks if a given bipartite graph has cycles
